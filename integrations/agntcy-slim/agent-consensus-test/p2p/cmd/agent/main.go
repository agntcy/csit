...
import (
	...
	agentrt "github.com/agntcy/csit/integrations/agntcy-slim/agent-consensus-test/p2p/internal/agent"
...
func main() {
	...
	grpcPort := flag.Int("grpc-port", 0, "P2P streaming gRPC port")
	...
	agentCard := &a2a.AgentCard{
		...
		Description: "SLIM vs P2P v2 consensus agent",
		Version:     "1.0.0",
	...
	if !*quiet {
		fmt.Printf("P2P_AGENT_READY agent=%s grpc=%d card=%d\n", *agentID, *grpcPort, card)
	}
