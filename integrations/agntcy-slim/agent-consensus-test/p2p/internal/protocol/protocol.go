...
// Package protocol defines the control/stream ops for the point-to-point (P2P)
// streaming relay topology.
//
// Unlike SLIM's native group session, P2P streaming has no group multicast:
// findings must pass through the runner, which is the explicit relay hub. Two
// server-streaming legs carry findings:
